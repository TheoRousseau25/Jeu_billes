 ...
 * 
 * */
static double maxVitessesCarrées(Vector<exodecorateur_angryballs.modele.Bille> billes2)
{
...
for ( i = 0; i < billes2.size(); ++i)
    if ( (vitesse2Courante = billes2.get(i).getVitesse().normeCarrée()) > vitesse2Max)
