...
import exodecorateur_angryballs.maladroit.VueBillardFactice;
...
Bille bille1 = new BilleNormale(centreBille1, rayonBille1, vitesseBille1, Color.blue);
bille1 = new BilleMvtRUPasseMurailles(bille1);
billes.add(bille1);

Vecteur centreBille2 = new Vecteur(20,50);
double rayonBille2 = 15;
Vecteur vitesseBille2 = new Vecteur (5,-5);
Bille bille2 = new BilleNormale(centreBille2, rayonBille2, vitesseBille2, Color.blue);
bille2 = new BilleMvtRUPasseMurailles(bille2);
billes.add(bille2);
